...
<script type="text/javascript" src="./instyle/login/js/jquery-1.8.2.min.js"></script>
...
<div class="screenbg">
	<ul>
		<li><a href="javascript:;"><img src="./instyle/login/images/0.jpg"></a></li>
		<li><a href="javascript:;"><img src="./instyle/login/images/1.jpg"></a></li>
		<li><a href="javascript:;"><img src="./instyle/login/images/2.jpg"></a></li>
	</ul>
</div>
