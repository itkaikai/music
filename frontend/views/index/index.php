      ...
      <a href class="off-screen-toggle hide" data-toggle="class:off-screen" data-target=".app-aside" ></a>
        <!-- COPY the content from "tpl/" -->
          <div class="hbox hbox-auto-xs hbox-auto-sm">
            <div class="col">
              <div style="background:url(./instyle/index/img/c4.jpg) center center; background-size:cover">
                <div class="wrapper-lg bg-white-opacity">
                  <div class="row m-t">
                    <div class="col-sm-7">
                      <a href class="thumb-lg pull-left m-r">
                        <img src="./instyle/index/img/a0.jpg" class="img-circle">
                      </a>
                      <div class="clear m-b">
                ...
                <div class="streamline b-l b-info m-l-lg m-b padder-v">
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="./instyle/index/img/a9.jpg" class="img-circle" alt="...">
                    </a>
                    <div class="m-l-lg">
                      <div class="m-b-xs">
                  ...
                  <div class="m-l-lg">
                    <a class="pull-left thumb-sm avatar">
                      <img src="./instyle/index/img/a5.jpg" alt="...">
                    </a>          
                  ...
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="./instyle/index/img/a3.jpg" alt="...">
                    </a>          
                  ...
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="./instyle/index/img/a6.jpg" class="img-circle" alt="...">
                    </a>
                    <div class="m-l-lg m-b-lg">
                      ...
                      <div class="m-b">
                        ...
                        <img src="./instyle/index/img/c5.jpg" class="b b-a wrapper-xs bg-white img-responsive">
                        <div class="m-t-sm">
                          <a href class="text-muted m-xs"><i class="icon-action-redo"></i></a>
                          <a href class="text-muted m-xs"><i class="icon-star"></i></a>
                          <a href class="text-muted m-xs"><i class="icon-refresh"></i> 13</a>
                  ...
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="./instyle/index/img/a4.jpg" class="img-circle" alt="...">
                    </a>
                    <div class="m-l-lg m-b-lg">
                      <div class="m-b-xs">
                  ...
                  <div>
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                      <img src="./instyle/index/img/a2.jpg" alt="...">
                    </a>          
                  ...
                  <ul class="list-group no-bg no-borders pull-in">
                    <li class="list-group-item">
                      <a herf class="pull-left thumb-sm avatar m-r">
                        <img src="./instyle/index/img/a4.jpg" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <a herf class="pull-left thumb-sm avatar m-r">
                        <img src="./instyle/index/img/a5.jpg" alt="..." class="img-circle">
                        <i class="on b-white bottom"></i>
                      </a>
                      <div class="clear">
                    ...
                    <li class="list-group-item">
                      <a herf class="pull-left thumb-sm avatar m-r">
                        <img src="./instyle/index/img/a6.jpg" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <a herf class="pull-left thumb-sm avatar m-r">
                        <img src="./instyle/index/img/a7.jpg" alt="..." class="img-circle">
